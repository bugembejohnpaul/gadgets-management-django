    ...
    if request.method =='POST':
        ...
        while True:
            ...
            for barcode in barcodes: 
                ...
                msg = "Barcode:{} Type:{}".format(barcodeData,barcodeType)
                cv2.putText(frame,msg,(x,y-10),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,0,255),1)
...
def add_age(request):
    if request.method =="POST":
        ...
        new_age = Age(name=name,age=age)
        new_age.save()
    return render(request,'add_age.html',{})
    # return HttpResponse("Inserted age....")

    # End of Age Demo......................................


# View Age Demo.........................
def view_age(request):
    age_results = Age.objects.all()
    return render(request, 'view_age.html', {'age_results': age_results})
# End of Age DEmo ...................
